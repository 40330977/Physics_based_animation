...
int main()
{
	...
	sphereholder[0].setPos(glm::vec3(0.5f, 1.0f, 10.0f));
	sphereholder[0].setVel(glm::vec3(0.0f, 0.0f, -28.0f));
	sphereholder[0].setAngAccl(glm::vec3(-40.0f, -30.0f, 0.0f));
	sphereholder[1].setPos(glm::vec3(1.0f, 1.0f, -3.0f));
