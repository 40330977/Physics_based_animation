...
public:
	...
	//get and set methods complete below
...
private:
	...
	float m_rest; //resting spring length

	Body* m_b1; //pointer to the body connected to one end of spring
	Body* m_b2; //pointer to body connected to other spring end
};